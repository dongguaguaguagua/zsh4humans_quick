...
# git clone, curl or wget dongguaguaguagua/zsh4humans_quick

. "$Z4H"/zsh4humans/main.zsh
```

`dongguaguaguagua/zsh4humans_quick` shouldn't be hard-coded but derived from `$Z4H_URL`.
...
`dongguaguaguagua/zsh4humans_quick` is renamed. So it's OK to never update the root `z4h.zsh`. But updating it
...
https://github.com/dongguaguaguagua/zsh4humans_quick/issues/35#issuecomment-657515701.

---

Currently `find` for recursive completions is called with `-xdev`. This should be customizable.
See https://github.com/dongguaguaguagua/zsh4humans_quick/issues/35#issuecomment-660477146.
...
Make `Alt+{Up,Left,Right}` work within `fzf`. See [this comment](
  https://github.com/dongguaguaguagua/zsh4humans_quick/issues/35#issuecomment-674357739).
...
https://github.com/dongguaguaguagua/zsh4humans_quick/issues/35#issuecomment-719639084 are here:
...
https://github.com/dongguaguaguagua/zsh4humans_quick/issues/35#issuecomment-720134760.
...
screen gets cleared unnecessarily. See https://github.com/dongguaguaguagua/zsh4humans_quick/issues/159. This can
